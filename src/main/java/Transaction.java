...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        //ensures that each transaction must have sufficient funds to cover the transaction amount,
        //preventing invalid or underfunded transactions from being added to the blockchain.
        ...
        for(TransactionInput i : inputs) {
            ...
            Blockchain.UTXOs.remove(i.getUTXO().id);
        }
